...
class ContentsController extends Controller
{
    ...
    {
        $datalist = Contents::where('user_id',Auth::id())->get();
        return view('home.user_contents', ['datalist' => $datalist]);
    }
    ...
    public function create()
    {
        ...
        return view('home.user_contents_add', ['datalist' => $datalist]);
    }
    ...
    public function edit(Contents $contents,$id)
    {
        ...
        return view('home.user_contents_edit',['data' => $data,'datalist' => $datalist]);
    }
    ...
    public function update(Request $request, Contents $contents, $id)
    {
        ...
        $data->save();
        return redirect()->route('user_contents')->with('success','Contents Added Successfully');
    }
