...
<body>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form role="form" action="{{route('admin_image_store',['contents_id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <table class="table">
                                    ...
                                    @foreach($images as $rs)
                                        <tr>
                                            ...
                                            <td>{{$rs->id}}</td>
                                            <td>{{$rs->title}}</td>
                                            <td><a href="{{route('admin_image_delete', ['id' => $rs-> id,'contents_id'=>$data->id])}}" onclick="return confirm('Record will be Delete ! Are you sure?')"><img src="{{asset('assets/admin/images')}}/delete.png" height="45"></a>
                                                </a>
                                            </td>
                                        </tr>
                                    @endforeach
